 ...
 */
final class Version20200904091407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE monster (id INT AUTO_INCREMENT NOT NULL, pantheon_id INT NOT NULL, gender_id INT NOT NULL, name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, place VARCHAR(255) NOT NULL, history VARCHAR(500) NOT NULL, picture VARCHAR(255) NOT NULL, INDEX IDX_245EC6F4AEC0A9E8 (pantheon_id), INDEX IDX_245EC6F4708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hero (id INT AUTO_INCREMENT NOT NULL, pantheon_id INT NOT NULL, gender_id INT NOT NULL, name VARCHAR(255) NOT NULL, origin VARCHAR(255) NOT NULL, exploits VARCHAR(500) NOT NULL, picture VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_51CE6E86AEC0A9E8 (pantheon_id), INDEX IDX_51CE6E86708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE god (id INT AUTO_INCREMENT NOT NULL, pantheon_id INT NOT NULL, gender_id INT NOT NULL, name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, domain VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, attributes VARCHAR(255) NOT NULL, history VARCHAR(500) NOT NULL, INDEX IDX_1A63D69EAEC0A9E8 (pantheon_id), INDEX IDX_1A63D69E708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
